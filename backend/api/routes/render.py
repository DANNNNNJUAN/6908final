...
async def preview(
    ...
    try:
        ...
        if api_key_invalid:
            ...
            return JSONResponse(
                ...
                content={
                    ...
                    "message": "The API key you provided is invalid or expired. Check your profile or server configuration.",
                },
            )
        ...
        if quota_exhausted:
            ...
            return JSONResponse(
                ...
                content={
                    ...
                    "message": "Your free quota has been exhausted. Redeem an invitation code to continue.",
        ...
        if img is None:
            ...
            return JSONResponse(
                status_code=500,
                content={"error": "image_generation_failed", "message": "Image generation failed"},
            )
...
async def preview_stream(
    ...
    async def stream():
        try:
            yield _sse_event("status", {"stage": "generating", "message": "Generating..."})
            effective_v = await resolve_preview_voltage(v, mac)
            parsed_mode_override = None
            if mode_override:
                try:
            ...
            if quota_exhausted:
                ...
                return
            yield _sse_event("status", {"stage": "rendering", "message": "Rendering..."})
            png_bytes = image_to_png_bytes(img)
