...
const coreModes = [
  {
    name: "DAILY",
    label: "Daily",
    desc: "Quotes, book picks and curious facts",
    descLines: ["Quotes, book picks", "and curious facts"],
    icon: CloudSun,
  },
  {
    name: "WEATHER",
    label: "Weather",
    desc: "Live weather and trend board",
    descLines: ["Live weather and", "trend board"],
    icon: CloudSun,
  },
  {
    name: "POETRY",
    label: "Poetry",
    desc: "Classical poems with short notes",
    descLines: ["Classical poems", "with short notes"],
    icon: ScrollText,
  },
  {
    name: "ARTWALL",
    label: "Gallery",
    desc: "Seasonal black-and-white artwork",
    descLines: ["Seasonal B/W", "artwork"],
    icon: Palette,
  },
  {
    name: "ALMANAC",
    label: "Almanac",
    desc: "Lunar calendar and daily dos",
    descLines: ["Lunar calendar", "and daily dos"],
    icon: Calendar,
  },
  {
    name: "BRIEFING",
    label: "Briefing",
    desc: "Tech hot topics + AI insights",
    descLines: ["Tech topics + AI", "insight brief"],
    icon: Newspaper,
  },
];
...
const moreModes = [
  {
    name: "STOIC",
    label: "Stoic",
    desc: "A daily philosophical quote",
    icon: BookOpen,
  },
  {
    name: "ZEN",
    label: "Zen",
    desc: "One large character for your mood",
    icon: CircleDot,
  },
  {
    name: "RECIPE",
    label: "Recipe",
    desc: "Meal ideas by time of day",
    icon: UtensilsCrossed,
  },
  {
    name: "COUNTDOWN",
    label: "Countdown",
    desc: "Countdown or count-up for events",
    icon: Timer,
  },
  {
    name: "MEMO",
    label: "Memo",
    desc: "Display your custom note text",
    icon: ScrollText,
  },
  {
    name: "HABIT",
    label: "Habit",
    desc: "Daily habit completion progress",
    icon: Target,
  },
  {
    name: "ROAST",
    label: "Roast",
    desc: "Light, humorous roasting style",
    icon: Flame,
  },
  {
    name: "FITNESS",
    label: "Fitness",
    desc: "Home workout tips and moves",
    icon: Dumbbell,
  },
  {
    name: "LETTER",
    label: "Letter",
    desc: "A slow letter across time",
    icon: Mail,
  },
  {
    name: "THISDAY",
    label: "On This Day",
    desc: "Historic events of today",
    icon: Globe,
  },
  {
    name: "RIDDLE",
    label: "Riddle",
    desc: "Riddles and brain teasers",
    icon: HelpCircle,
  },
  {
    name: "QUESTION",
    label: "Question",
    desc: "One open-ended question each day",
    icon: MessageCircleQuestion,
  },
  {
    name: "BIAS",
    label: "Bias",
    desc: "A cognitive bias per day",
    icon: Lightbulb,
  },
  {
    name: "STORY",
    label: "Story",
    desc: "A complete micro-story in three acts",
    icon: PenTool,
  },
  {
    name: "LIFEBAR",
    label: "Life Bar",
    desc: "Progress view for year/month/week/life",
    icon: BarChart3,
  },
  {
    name: "CHALLENGE",
    label: "Challenge",
    desc: "A 5-minute daily micro challenge",
    icon: Target,
  },
];
...
const specs = [
  {
    icon: Cpu,
    label: "ESP32-C3",
    desc: "RISC-V architecture, Wi-Fi connectivity, ultra-low power",
  },
  {
    icon: Monitor,
    label: "4.2-inch E-Ink",
    desc: "Paper-like, glare-free, ideal for always-on desk display",
  },
  {
    icon: Battery,
    label: "Battery Life",
    desc: "LiFePO4 battery with deep sleep mode",
  },
  {
    icon: DollarSign,
    label: "BOM < CNY 220",
    desc: "Open-source hardware that anyone can build",
  },
];
        ...
        <div className="mx-auto max-w-6xl px-6 py-20 text-center">
          ...
          <p className="text-ink-light mb-8 max-w-md mx-auto">
            ...
            {!isEn && (
              <>
                <br />
                All you need is one ESP32 and one e-ink panel.
              </>
            )}
          </p>
