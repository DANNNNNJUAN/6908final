    ...
    <Card>
      <CardHeader className="pb-2">
        <CardTitle className="flex items-baseline justify-between gap-3 flex-wrap">
          <span className="text-base font-semibold text-ink">{tr("E-Ink Preview", "E-Ink Preview")}</span>
          ...
          {previewLoading ? (
            <div className="flex items-center justify-center w-full">
              <div className="text-center">
                ...
                <p className="text-sm text-ink-light">{previewStatusText || tr("Generating preview...", "Generating preview...")}</p>
              </div>
            </div>
          ) : previewImg ? (
            ...
            <div className="flex items-center justify-center w-full">
              <div className="text-center">
                ...
                <p className="text-sm text-ink-light">{tr("Click Preview on any mode to view output", "Click Preview on any mode to view output")}</p>
              </div>
            </div>
          )}
        </div>
        ...
        <div className="border-t border-ink/10 p-3 bg-white">
          {previewImg && !previewLoading && previewCacheHit === true ? (
            <div className="mb-2 text-xs text-amber-700 bg-amber-50 border border-amber-200 rounded-sm px-2 py-1.5">
              {tr(
                "The current preview is from cache. Click “Regenerate Preview” to view the latest result.",
          ...
          <div className="flex gap-2 items-center">
            ...
            >
              {tr("Regenerate Preview", "Regenerate Preview")}
            </Button>
            <Button
              variant="outline"
              size="sm"
            ...
            >
              ...
              {tr("Apply to E-Ink", "Apply to E-Ink")}
            </Button>
